 ...
 */
export function parseCalendarCursor(cursor?: string): Record<string, string> {
  if (!cursor) return {};
  try {
...
export function serializeCalendarCursor(tokens: Record<string, string>): string | undefined {
